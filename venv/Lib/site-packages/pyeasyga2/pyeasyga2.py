...
class GeneticAlgorithm(object):
    ...
    def calculate_population_fitness(self):
        ...
        for individual in self.current_generation:
            individual.fitness = self.fitness_function(
                individual.genes, self.seed_data)[0]
            individual.genes = self.fitness_function(
                individual.genes, self.seed_data)[1]
    ...
    def run(self):
        ...
        fitnesy=[]
        i=0
        while self.current_generation[0].fitness != 0 and i<self.generations:
            najlepsi.append(self.best_individual()[1])  # zapisywanie najlepszego osobnika
            fitnesy.append(self.best_individual()[0])  # zapisywanie fitnessu najlepszego osobnika
            self.create_next_generation()
            i=i+1
            print(i)
        najlepsi.append(self.best_individual()[1])
        fitnesy.append(self.best_individual()[0])
        return [fitnesy,najlepsi]
